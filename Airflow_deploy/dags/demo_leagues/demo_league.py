...
default_arguments = {   'owner': 'NestorSaenz',
                        'email': 'nes164@gmail.com',
                        'retries':1 ,
...
with DAG('FOOTBAL_LEAGUES',
         ...
         upload_stage = SnowflakeOperator(
                    ...
                    sql='./querys/upload_stage.sql',
                    snowflake_conn_id='https://kdb23800.us-east-1.snowflakecomputing.com',
